...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        const requiredFields = ['id', 'event', 'quantity', 'totalAmount', 'customerFirstName', 'customerLastName', 'purchaseDate'];
        ...
        if (!ticketData.event.name || !ticketData.event.date) {
            return {
                statusCode: 400,
                headers: {
                    ...headers,
        ...
        // Générer le pass
        const passBuffer = await passSigner.createEventTicketPass(ticketData);
        ...
        console.error('Erreur lors de la création du pass d\'événement:', error);
