...
async function uploadCertificateToSupabase(certificatePath) {
    try {
        ...
        if (!supabaseUrl || !supabaseKey) {
            ...
            console.log('Assure-toi d\'avoir SUPABASE_URL et SUPABASE_ANON_KEY dans ton .env');
            process.exit(1);
        }
...
if (process.argv.length < 3) {
    ...
    console.log('');
    console.log('⚠️  Assure-toi d\'avoir configuré SUPABASE_URL et SUPABASE_ANON_KEY dans ton .env');
    process.exit(1);
}
